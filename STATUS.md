...
| Field | Value |
| ------- | ------- |
| Active branch | `main` (PR #11 merged) |
...
| Item | Status |
| ------ | -------- |
| npm package | `@aravi1008/ui@1.0.1` |
| Current version on npm | `1.0.1` (published 2026-03-26 via semantic-release) |
| Tests | 207 passing |
...
1. `feat/typography-utils` — responsive font sizes (av-text-xs → av-text-9xl), letter-spacing, line-height, font-weight utilities
2. More data-driven components — `createList`, `createForm`, `createSelect`
3. Documentation site — usage examples, token reference, component demos
